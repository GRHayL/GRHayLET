...
| Page ID | Page | Type | Status | Review date | Aliases / query terms |
| --- | --- | --- | --- | --- | --- |
| `grhaylhd.index` | [GRHayLHD](index.md) | router | router | n/a | branch; root; router; scope |
| `grhaylhd.schema` | [Schema](SCHEMA.md) | governance | reviewed | 07-17-2026 | schema; authority; locator |
| `grhaylhd.lint` | [Lint Checks](lint/CHECKS.md) | governance | reviewed | 07-17-2026 | lint; checker; validation |
| `grhaylhd.catalog` | [Catalog](catalog.md) | governance | reviewed | 07-17-2026 | pages; aliases; routes |
| `grhaylhd.glossary` | [Glossary](glossary.md) | governance | reviewed | 07-17-2026 | terms; owners; routing meaning |
| `grhaylhd.source-map` | [Source Map](source-map.md) | governance | reviewed | 07-17-2026 | evidence edges; reverse dependencies |
...
| `grhaylhd.evolution.eos-entropy-variants` | [EOS and Entropy Variants](evolution/eos-entropy-variants.md) | leaf | reviewed | 07-17-2026 | Hybrid; Simple; Tabulated; entropy; mode matrix |
...
| `grhaylhd.evolution.conservative-recovery` | [Conservative Recovery](evolution/conservative-recovery.md) | leaf | reviewed | 07-17-2026 | Con2Prim; atmosphere; averaging; Font1D; diagnostics |
| `grhaylhd.evolution.rhs-fluxes-and-sources` | [RHS Fluxes and Sources](evolution/rhs-fluxes-and-sources.md) | leaf | reviewed | 07-17-2026 | source RHS; flux RHS; PPM; HLLE; interpolation |
| `grhaylhd.evolution.matter-boundaries-and-symmetry` | [Matter Boundaries and Symmetry](evolution/matter-boundaries-and-symmetry.md) | leaf | reviewed | 07-17-2026 | copy; outflow; frozen; faces; inflow; symmetry |
| `grhaylhd.evolution.perturbations-and-diagnostics` | [Perturbations and Diagnostics](evolution/perturbations-and-diagnostics.md) | leaf | reviewed | 07-17-2026 | perturbation; random seed; OpenMP; failure checker |
