...
extern void GRHayLMHD_tabulated_calculate_flux_dir_rhs(
...
void GRHayLMHD_tabulated_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  ...
  */
  int flux_dir = 0;
  GRHayLMHD_tabulated_calculate_flux_dir_rhs(
