...
static void GRHayLHD_tabulated_evaluate_sources_rhs(CCTK_ARGUMENTS) {
...
void GRHayLHD_driver_evaluate_MHD_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;

  GRHayLHD_tabulated_evaluate_sources_rhs(cctkGH);
