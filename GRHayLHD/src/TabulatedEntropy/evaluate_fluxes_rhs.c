    ...
    for (int k = kmin; k < kmax + 1; k++) {
      for (int j = jmin; j < jmax + 1; j++) {
        for (int i = imin; i < imax + 1; i++) {
          ...
          ghl_tabulated_compute_eps_T_from_P(ghl_eos, prims_r.rho, prims_r.Y_e, prims_r.press, &prims_r.eps, &prims_r.temperature);
          ghl_tabulated_compute_eps_T_from_P(ghl_eos, prims_l.rho, prims_l.Y_e, prims_l.press, &prims_l.eps, &prims_l.temperature);
          // clang-format on
