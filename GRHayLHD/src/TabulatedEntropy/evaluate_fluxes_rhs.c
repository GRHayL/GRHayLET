      ...
      for(int j=jmin; j<jmax+1; j++) {
        for(int i=imin; i<imax+1; i++) {
          ...
          for(int ind=0; ind<6; ind++) {
            ...
            others_stencil[3][ind] = entropy[stencil];
            others_stencil[4][ind] = Y_e[stencil];
          }
          ...
          prims_r.vU[0]   = others_r[0];
          prims_r.vU[1]   = others_r[1];
          prims_r.vU[2]   = others_r[2];
          prims_r.entropy = others_r[3];
          prims_r.Y_e     = others_r[4];

          prims_l.BU[0] = prims_l.BU[1] = prims_l.BU[2] = 0.0;
          prims_l.rho     = rhol;
          prims_l.press   = pressl;
          prims_l.vU[0]   = others_l[0];
          prims_l.vU[1]   = others_l[1];
          prims_l.vU[2]   = others_l[2];
          prims_l.entropy = others_l[3];
          prims_l.Y_e     = others_l[4];
