...
extern "C" void IllinoisGRMHDX_compute_ccc_centered_spacetime_quantities(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_IllinoisGRMHDX_compute_ccc_centered_spacetime_quantities;
  ...
  grid.loop_all_device<1, 1, 1>(
     ...
     *******************************************/
    const CCTK_REAL Psi4 = pow(psiL,4);
    sqrt_detgamma(index) = sqrt(gijdet);
