...
extern "C" void GRHayLMHDX_compute_ccc_centered_spacetime_quantities(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLMHDX_compute_ccc_centered_spacetime_quantities;
