...
void GRHayLMHDX_evaluate_flux_source_rhs_dir(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLMHDX_evaluate_flux_source_rhs;
...
extern "C" void GRHayLMHDX_evaluate_flux_source_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLMHDX_evaluate_flux_source_rhs;
  DECLARE_CCTK_PARAMETERS;

  GRHayLMHDX_evaluate_flux_source_rhs_dir<0>(cctkGH);
  GRHayLMHDX_evaluate_flux_source_rhs_dir<1>(cctkGH);
  GRHayLMHDX_evaluate_flux_source_rhs_dir<2>(cctkGH);
}
