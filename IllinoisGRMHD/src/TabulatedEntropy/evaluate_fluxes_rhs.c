...
extern void IllinoisGRMHD_tabulated_entropy_calculate_flux_dir_rhs(
...
void IllinoisGRMHD_tabulated_entropy_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_IllinoisGRMHD_tabulated_entropy_evaluate_fluxes_rhs;
  ...
  */
  int flux_dir = 0;
  IllinoisGRMHD_tabulated_entropy_calculate_flux_dir_rhs(
  ...
  */
  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 1, var_indices, press, ghl_vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
...

  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 6, var_indices, press, ghl_vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
  ...
  */
   ...
   ******************************************/
  flux_dir=2;
  IllinoisGRMHD_A_flux_rhs(cctkGH, flux_dir, out_prims_r, out_prims_l, cmin, cmax, Az_rhs);
  ...
  */
  ...
  // single array
  IllinoisGRMHD_A_flux_rhs(cctkGH, flux_dir, out_prims_r, out_prims_l, cmin, cmax, Ax_rhs);
  ...
  */
  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 5, var_indices, press, ghl_vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
   ...
   ******************************************/
  flux_dir=1;
  IllinoisGRMHD_A_flux_rhs(cctkGH, flux_dir, out_prims_r, out_prims_l, cmin, cmax, Ay_rhs);
}
