...
extern void IllinoisGRMHD_hybrid_entropy_calculate_flux_dir_rhs(
...
void IllinoisGRMHD_hybrid_entropy_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  ...
  */
  int flux_dir = 0;
  IllinoisGRMHD_hybrid_entropy_calculate_flux_dir_rhs(
