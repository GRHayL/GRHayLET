...
extern void IllinoisGRMHD_tabulated_calculate_flux_dir_rhs(
...
void IllinoisGRMHD_tabulated_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_IllinoisGRMHD_tabulated_evaluate_fluxes_rhs;
  ...
  */
  int flux_dir = 0;
  IllinoisGRMHD_tabulated_calculate_flux_dir_rhs(
