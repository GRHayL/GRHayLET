...
extern void IllinoisGRMHD_hybrid_calculate_flux_dir_rhs(
...
void IllinoisGRMHD_hybrid_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_IllinoisGRMHD_hybrid_evaluate_fluxes_rhs;
  ...
  */
  int flux_dir = 0;
  IllinoisGRMHD_hybrid_calculate_flux_dir_rhs(
