...
void IllinoisGRMHD_evaluate_MHD_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_IllinoisGRMHD_evaluate_MHD_rhs;
  ...
  */
  int flux_dir = 0;
  IllinoisGRMHD_calculate_MHD_dirn_rhs(cctkGH, flux_dir, dX,
  ...
  */
  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 1, var_indices, rho_b, pressure, vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
...

  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 6, var_indices, rho_b, pressure, vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
  ...
  */
  {
    ...
    IllinoisGRMHD_reconstruction_loop(cctkGH, flux_dir, 5, var_indices, rho_b, pressure, vel[flux_dir], in_prims, out_prims_r, out_prims_l);
  }
