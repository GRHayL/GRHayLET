...
void GRHayLHDX_hybrid_evaluate_fluxes_dir(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_hybrid_evaluate_fluxes;
...
extern "C" void GRHayLHDX_hybrid_evaluate_fluxes(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_hybrid_entropy_evaluate_fluxes;
  DECLARE_CCTK_PARAMETERS;

  GRHayLHDX_hybrid_evaluate_fluxes_dir<0>(cctkGH);
  GRHayLHDX_hybrid_evaluate_fluxes_dir<1>(cctkGH);
  GRHayLHDX_hybrid_evaluate_fluxes_dir<2>(cctkGH);
}
