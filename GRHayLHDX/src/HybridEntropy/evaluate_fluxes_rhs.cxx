...
void GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs_dir(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs;
...
extern "C" void GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs;
  DECLARE_CCTK_PARAMETERS;

  GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs_dir<0>(cctkGH);
  GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs_dir<1>(cctkGH);
  GRHayLHDX_hybrid_entropy_evaluate_fluxes_rhs_dir<2>(cctkGH);
}
