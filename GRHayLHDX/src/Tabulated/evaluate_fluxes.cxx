...
void GRHayLHDX_tabulated_evaluate_fluxes_dir(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_tabulated_evaluate_fluxes;
  ...
  constexpr void (*calculate_HLLE_fluxes)(
    ...
    = flux_dir==0 ? &ghl_calculate_HLLE_fluxes_dirn0_tabulated :
...
extern "C" void GRHayLHDX_tabulated_evaluate_fluxes(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_GRHayLHDX_tabulated_evaluate_fluxes;
  DECLARE_CCTK_PARAMETERS;

  GRHayLHDX_tabulated_evaluate_fluxes_dir<0>(cctkGH);
  GRHayLHDX_tabulated_evaluate_fluxes_dir<1>(cctkGH);
  GRHayLHDX_tabulated_evaluate_fluxes_dir<2>(cctkGH);
}
